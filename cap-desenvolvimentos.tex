...
%TODO: Arrumar esta parte
Alternativamente, foi sugerido em uma reunião, a possibilidade de integração do OpenTuner em um bot que escolhe técnicas de aposta, integrando-o no Salty Bet, um jogo online onde pode-se apostar dinheiro virtual em personagens de um jogo de luta, todos controlados por inteligências artificiais. O bot trabalharia lendo a conversa dos usuários, onde os resultados são anunciados, e devolvendo para o tuner, em quem foi a aposta, de quanto foi, e o resultado.

Foi feito um novo esforço para tentar trabalhar com Doom e seu gerador de mapas. A pesquisa por bots que pudessem jogar consistentemente o modo single-player de Doom foi iniciada novamente, mas encontrou novamente os mesmo problemas que envolvem a pesquisa de um programa tão antigo. Muitos sites antigos e desatualizados foram encontrados, e muitos projetos parados há anos. Mesmo encontrando uma comunidade recente de jogadores de ports de Doom, não obtivemos sucesso em encontrar os elusivos bots.

Foi dada a ideia, por nosso orientador, de mover os esforços para um jogo mais recente, mas similar em espírito, como Quake Arena. O fato de um doutorando do professor Goldman ter trabalhado anteriormente com esta plataforma foi um ponto positivo levantado em uma reunião.
%Mencionar as ideias com SaltyBet
%TODO: Arrumar esta parte

%Inserir aqui o exemplo das árvores de habilidade!

%TODO: Introduzir o OpenTTD como o jogo escolhido, para expandi-lo na próxima seção
...
O OpenTTD tem suporte a inteliências artificiais, cujo comportamento é definido por um conjunto de scripts Squirrel , que é "uma linguagem de alto nível, imperativa e orientada a objetos, projetada para ser uma linguagem de script leve que se adequa aos requerimentos de banda, memória e processamento em tempo real para aplicações como jogos"\footnote{\url{www.squirrel-lang.org}}. Sua sintaxe é bastante similar à de C++. O OpenTTD tem seu próprio interpretador Squirrel, que executa um certo número de instruções de cada IA antes de interrompê-la por um breve período de tempo. Esses scripts são responsáveis por todas as ações que a IA pode tomar, como quais pontos de produção e consumo atender com seus veículos, como construir um caminho que atenda esse transporte, e quais veículos utilizar para isso.
%END RASCUNHO
...
Para ver se o Tuner funcionava, foram realizados testes de 10 e 50 anos com 8 IAs por iteração para valor da empresa, e de 10 anos com 6 IAs e 30 anos com 8 IAs para dinheiro em caixa e lucro. A IA utilizada foi uma versão modificada da ChooChoo \footnote{\url{http://www.tt-forums.net/viewtopic.php?t=44225}}. Testes de 10 anos foram executados numa máquina virtual cedida pelo Gnann e os testes mais longos foram feitos na Rá, o servidor web do USPGameDev. A intenção original era rodar esses testes por uma semana, mas crashes em pontos arbitrários, ocorrendo entre 8 e 72 horas após o início dos testes. Para os testes de caixa e lucro, o valor de semente inicial para o gerador de mapa do OpenTTD foi fixado, mas não durante os testes de valor da empresa, porque derp.
