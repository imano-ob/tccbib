...
Os testes consistem de uma execução do \textit{autotuner}, onde, a cada rodada, é escolhida uma configuração para o vetor de custos do \textit{pathfinder} da IA, o jogo instancia o número determinado de cópias dessa IA, os resultados observados são coletados e informados de volta para o OpenTuner, que escolhe uma nova configuração para a próxima iteração com base nos resultados observados.
