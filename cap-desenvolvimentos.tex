...
Otimização de parâmetros é um assunto que levanta certo interesse atualmente. Ela consiste em encontrar os parâmetros que geram o resultado desejado de uma aplicação sendo otimizada. %<- Tenho reservas em relação ao wording daqui --Renan
...
Para verificar o funcionamento do Tuner, foram realizados testes de 10 e 50 anos com 8 IAs por iteração para valor da empresa, e de 10 anos com 6 IAs e 30 anos com 8 IAs para dinheiro em caixa e lucro. Testes de 10 anos foram executados numa máquina virtual cedida por William Gnann, e os testes mais longos foram feitos na Rá, o servidor web do USPGameDev. O OpenTTD foi compilado com uma alteração que permite a execução dos ciclos de jogo muito mais rapidamente, reduzindo drasticamente o tempo necessário para uma iteração completa do OpenTuner. Essa alteração não era necessária para o funcionamento pleno dos testes, mas agilizou dramaticamente a geração de resultados.
