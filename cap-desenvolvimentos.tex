...
O Handler cuida do OpenTTD. Ele envia comandos para o servidor via pipe para o stdin do servidor e lê os outputs dele. Ele é responsável por iniciar IAs, parar IAs, ler respostas, e reiniciar o servidor quando necessário. Após iniciar as IAs, ele espera um output do jogo que respeita um formato específico, definido pelo padrão de output do OpenTTD e por uma convenção adotada para o ajuste fino. Ao detectar essa saída, que contém o resultado obtido e a identificação da IA, ele concatena esse resultado a um vetor de resultados, e devolve esse vetor quando todas as IAs terminarem.
