...
\begin{center}
    ...
    \vspace*{3cm}
    \Large{Renan Teruo Carneiro \\
    	Vitor Cerqueira Santos}
    

    \vspace{3cm}
    \textbf{\Large{Aplicando o Arcabouço  \\
    OpenTuner em Jogos Digitais}}
...
\bibliography{ref}  % associado ao arquivo: 'ref.bib'
