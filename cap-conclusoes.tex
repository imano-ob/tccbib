...
Com isso em mente, talvez seja possível obter resultados melhores se o jogo for desenvolvido com foco em automatização desde as etapas iniciais, e estruturando o \textit{tuner} de modo a aproveitar melhor as características do OpenTuner.
